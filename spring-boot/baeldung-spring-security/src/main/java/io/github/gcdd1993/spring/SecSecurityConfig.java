...
import io.github.gcdd1993.security.CustomRememberMeServices;
import io.github.gcdd1993.security.google2fa.CustomAuthenticationProvider;
import io.github.gcdd1993.security.google2fa.CustomWebAuthenticationDetailsSource;
import io.github.gcdd1993.security.location.DifferentLocationChecker;
...
//        final File resource = new File("src/main/resources/maxmind/GeoLite2-Country.mmdb");
        InputStream resource = SecSecurityConfig.class.getClassLoader().getResourceAsStream("maxmind/GeoLite2-Country.mmdb");
